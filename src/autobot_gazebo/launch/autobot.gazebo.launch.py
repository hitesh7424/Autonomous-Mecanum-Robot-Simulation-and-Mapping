...
def generate_launch_description():
    ...
    package_name_description = "autobot_description"
    package_name_bringup = "autobot_bringup"

    default_robot_name = "autobot"
    gazebo_models_path = "models"
    default_world_file = "empty.world"
    gazebo_worlds_path = "worlds"
    ros_gz_bridge_config_file_path = "config/ros_gz_bridge.yaml"
    rviz_config_filename = "autobot_gazebo.rviz"
    ...
    pkg_share_bringup = FindPackageShare(package=package_name_bringup).find(
        package_name_bringup
    )
    ...
    description_share_path = os.path.dirname(pkg_share_description)
    ...
    set_env_vars_resources = AppendEnvironmentVariable(
        ...
        gazebo_models_path + os.pathsep + description_share_path,
    )
    ...
    start_gazebo_ros_image_bridge_cmd = Node(
        ...
        remappings=[("/rgbd_camera/image", "/rgbd_camera/color/image_raw")],
    )
