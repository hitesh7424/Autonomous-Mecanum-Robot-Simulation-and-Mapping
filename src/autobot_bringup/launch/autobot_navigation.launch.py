...
def generate_launch_description():
    ...
    package_name_docking = "autobot_docking"
    package_name_gazebo = "autobot_gazebo"
    package_name_localization = "autobot_localization"
    package_name_navigation = "autobot_navigation"

    # Launch and config file paths
    apriltag_launch_file_path = "launch/apriltag_dock_pose_publisher.launch.py"
    gazebo_launch_file_path = "launch/autobot.gazebo.launch.py"
    ...
    nav2_params_path = "config/autobot_nav2_default_params.yaml"
    rviz_config_file_path = "rviz/nav2_default_view.rviz"

    # Set the path to different packages
    pkg_share_docking = FindPackageShare(package=package_name_docking).find(
        package_name_docking
    )
    ...
    pkg_share_navigation = FindPackageShare(package=package_name_navigation).find(
        package_name_navigation
    )
